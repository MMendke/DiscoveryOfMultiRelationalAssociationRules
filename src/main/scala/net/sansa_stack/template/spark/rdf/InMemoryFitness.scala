...
{
      private val tableVal = Preprocessing.tableValue //Vertical Partitioning  full url
      private val tD = Preprocessing.tableDetail // type of subject and object full url
      private val oL = Preprocessing.overLap //full url
      private val tableSize =Preprocessing.vpTableSizes // full url
